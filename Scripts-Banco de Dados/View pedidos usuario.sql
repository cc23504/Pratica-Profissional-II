CREATE VIEW ChargerHelp.ViewPedidosUsuario AS
...
FROM ChargerHelp.Armario AS A
    ...
    LEFT OUTER JOIN ChargerHelp.Pedido AS P ON A.id_armario = P.id_armario AND P.status_pedido <> 'Ativo' and P.status_pedido <> 'Aguardando'
